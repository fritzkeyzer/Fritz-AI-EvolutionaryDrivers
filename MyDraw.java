/******************************************************************************
 *  Compilation:  javac MyDraw.java
 *  Execution:    java MyDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code MyDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code MyDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "http://introcs.cs.princeton.edu/java/stdlib/MyDraw.java">MyDraw.java</a>
 ...
 *           MyDraw.setPenRadius(0.05);
 *           MyDraw.setPenColor(MyDraw.BLUE);
 *           MyDraw.point(0.5, 0.5);
 *           MyDraw.setPenColor(MyDraw.MAGENTA);
 *           MyDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code MyDraw.line()} and {@code MyDraw.point()}
 *  draw lines and points; the methods {@code MyDraw.setPenRadius()}
 *  and {@code MyDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code MyDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  </ul>
 *  <p>
 *  For example, {@code MyDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code MyDraw.setPenColor(MyDraw.MAGENTA)} sets the
 ...
 *  For example, {@code MyDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code MyDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   MyDraw.setFont(font);
 *   MyDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code MyDraw.clear(MyDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  @author Kevin Wayne
 */
public final class MyDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static MyDraw std = new MyDraw();
    ...
    ***************************************************************************/
     ...
     * {@code MyDraw.BLACK}, {@code MyDraw.BLUE}, {@code MyDraw.CYAN},
     * {@code MyDraw.DARK_GRAY}, {@code MyDraw.GRAY}, {@code MyDraw.GREEN},
     * {@code MyDraw.LIGHT_GRAY}, {@code MyDraw.MAGENTA}, {@code MyDraw.ORANGE},
     * {@code MyDraw.PINK}, {@code MyDraw.RED}, {@code MyDraw.WHITE}, and
     * {@code MyDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to MyDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = MyDraw.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(MyDraw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            MyDraw.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = MyDraw.userX(e.getX());
            mouseY = MyDraw.userY(e.getY());
            mousePressed = true;
        }
    }
    ...
    *  as an argument. It can handle action keys
    ...
    public static void main(String[] args) {
        MyDraw.square(.2, .8, .1);
        MyDraw.filledSquare(.8, .8, .2);
        MyDraw.circle(.8, .2, .2);

        MyDraw.setPenColor(MyDraw.BOOK_RED);
        MyDraw.setPenRadius(.02);
        MyDraw.arc(.8, .2, .1, 200, 45);

        // draw a blue diamond
        MyDraw.setPenRadius();
        MyDraw.setPenColor(MyDraw.BOOK_BLUE);
        double[] x = { .1, .2, .3, .2 };
        double[] y = { .2, .3, .2, .1 };
        MyDraw.filledPolygon(x, y);
        ...
        MyDraw.text(0.2, 0.5, "black text");
        MyDraw.setPenColor(MyDraw.WHITE);
        MyDraw.text(0.8, 0.8, "white text");
    }
